...
const FriendsBar: React.FC<FriendsBarProps> = ({func}) => {
    return (
        <div className='flex flex-col flex-grow bg-[#1e1e20]
            tablet:w-[300px]'>
                ...
                <button onClick={func} className='flex flex-row mx-4 w-auto'><img className='h-[25px] w-[30px]' src={wave} alt="waving person" />Friends</button>
